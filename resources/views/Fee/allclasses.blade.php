...
<div id="wrapper">
     <!-- Navigation -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                          ...
                          <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{route('class.view')}}">All  Classes</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('add.student')}}">Add Students</a>
                                </li>
                                <li>
                                    <a href="{{route('view.student')}}">All Students</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div class="graphs">
         ...
         <a href="{{route('view.class.session',$class->id)}}">
