...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$students->student_id}}<input type="hidden" name="studentid[]" value="{{$students->student_id}}"></td>
                ...
                <input type="hidden" name="sessionid[]" value="{{$students->userDetail->session_id}}">
